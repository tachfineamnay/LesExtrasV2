...
export default function MissionTrackingError({
    error,
    reset,
}: {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-slate-50 px-4">
            <div className="max-w-md w-full bg-white border border-slate-200 rounded-2xl shadow-sm p-6 text-center space-y-4">
                ...
                <div>
                    <h2 className="text-lg font-semibold text-slate-900">Suivi indisponible</h2>
                    <p className="text-sm text-slate-500 mt-1">
                        Le suivi detaille de la mission ne peut pas etre charge. Verifiez votre connexion ou reessayez.
                    </p>
                </div>
                <button
                    onClick={reset}
